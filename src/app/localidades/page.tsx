...
export default function LocalidadesPage() {
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10">
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">Localidades de Portugal</h1>
        <p className="text-gray-500 dark:text-gray-400">Explore todos os distritos, concelhos e freguesias de Portugal continental e ilhas.</p>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-8">
        {[
          ...
          <div key={s.label} className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl p-4 text-center shadow-card">
            <p className="text-2xl font-bold text-[#046A38] dark:text-green-400">{s.value}</p>
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between mb-3">
                <h2 className="font-bold text-gray-900 dark:text-gray-100 group-hover:text-[#046A38] dark:group-hover:text-green-400 transition-colors text-base">
                  {d.nome}
                </h2>
                <svg className="w-4 h-4 text-gray-300 dark:text-gray-600 group-hover:text-[#046A38] dark:group-hover:text-green-400 transition-colors shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="mt-10 card">
        <h2 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-3">Sobre as Localidades de Portugal</h2>
